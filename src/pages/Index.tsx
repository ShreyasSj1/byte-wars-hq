    ...
    <div className="min-h-screen">
                ...
                <CardContent className="p-6 sm:p-8 flex flex-col justify-center h-full">
                  <ul className="space-y-4 sm:space-y-5">
                    {[
                      ...
                      "Allocation will follow a first-come, first-serve basis and will be confirmed via WhatsApp",
                      "A working prototype or demo must be built during the event — no fully pre-built projects",
                      "AI tools are encouraged (ChatGPT, Canva etc.) — participants must be able to explain their usage",
                      "A short write-up or documentation must be submitted along with the final project",
                    ].map((rule, index) => (
      ...
      <section id="contact" className="py-16 sm:py-24 md:py-32 relative overflow-hidden">
        <div className="container mx-auto px-4 sm:px-6 md:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground mb-10 sm:mb-14 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 max-w-2xl mx-auto">
            ...
            <a
              ...
              className="group bg-card border-2 border-primary/30 rounded-2xl p-8 shadow-card hover:shadow-neon-purple hover:border-primary transition-all duration-300 flex flex-col items-center gap-4"
            >
              ...
              <p className="text-primary font-semibold text-lg">7795865456</p>
            </a>
            ...
            >
              ...
              <p className="text-primary font-semibold text-lg">Chat with us</p>
            </a>
          </div>
        </div>
      </section>
